...
export default function Modal() {
  ...
  function donateNow() {
    const amount = sliderRef.current.value;
                ...
                <div className="relative p-6 flex-auto">
                  <div className="grid grid-cols-2" id="gift-grid">
                    <div>
                      ...
                      <div
                        className="relative grid grid-cols-2 border rounded-full text-center"
                        style={{
                          borderColor: "#CCC",
                        ...
                        id="gift-frequency"
                      >
                        <div className="border rounded-full text-orange text-center">Monthly</div>
                        <div>One time</div>
                      </div>
                    </div>
                    <div>
                      ...
                      <div className="slidecontainer relative">
                        ...
                        <input type="range" min={minDonationAmount} max={maxDonationAmount} className="slider relative z-10" id="donation-slider" defaultValue={startingDonationAmount} onChange={updateDonationAmount} ref={sliderRef} />
                      </div>
                    </div>
                  </div>
