                ...
                return global.group.title == "Crypto" &&
                    <div key={index}>
                        <>
                            ...
                            >
                                <div className="font-bold text-xl font-mont">{JSON.parse(global.column_values[0].value)}<span className="font-light"> {JSON.parse(global.column_values[1].value)}</span></div>
