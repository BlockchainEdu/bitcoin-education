...
export default function HeaderWithLogo() {
    ...
    return (
        <section className={`py-10 px-7 sticky w-full top-0 z-10 orange-header header ${ offset > 0 ? "scrolled" : "" }`}>
          ...
          <nav className="hidden lg:flex max-w-7xl m-auto justify-between items-center relative">
            ...
            <div className="w-2/12 lg:w-1/3 absolute lg:relative top-[-1.25rem] lg:top-0 left-0"><a href="/"><img className="m-auto w-20" src="/images/ben-vertical-alt.svg" /></a></div>
