          ...
          <div className="border-0 donation-modal rounded-2xl shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
            ...
            <div className="relative p-6 flex-auto">
              ...
              <div className="flex flex-col md:flex-row space-x-0 md:space-x-4">
                ...
                <div className="w-full md:w-8/12 mt-8 md:mt-0 px-14 md:px-0">
              ...
              <div className="hover:cursor-pointer text-orange underline flex md:hidden justify-center mt-3 md:mt-0" onClick={() => props.otherClick()}>Other</div>
