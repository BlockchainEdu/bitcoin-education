            ...
            <div className="relative w-auto my-6 mx-auto max-w-5xl">
              ...
              <div className="border-0 donation-modal rounded-2xl shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                ...
                <div className="relative p-6 flex-auto">
                  <div className="pipedriveWebForms mx-auto justify-center w-full" style={{width:"300px", height:"300px"}} data-pd-webforms="https://webforms.pipedrive.com/f/6UURQKVAXIrvlnr2T6iyOX75xqbyYdLp6iHKmGYWedgMyJ25vpNmlZn3V8s8LEi9hx"><script src="https://webforms.pipedrive.com/f/loader"></script></div>
