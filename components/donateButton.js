              ...
              <div className="border-0 donation-modal rounded-2xl shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                ...
                <div className="relative p-6 flex-auto">
                  ...
                  <div className="flex flex-col md:flex-row gap-y-7 md:gap-y-0 pt-10 gap-x-10">
                    ...
                    <button className="border font-bold text-xl px-8 rounded-full py-4 text-benblack-500 hover:text-white transition duration-500 hover:bg-bengrey-300 transition duration-500 hover:border-bengrey-300">
                      Give with PayPal
                    </button>
                    </a>
