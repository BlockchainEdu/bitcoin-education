...
class MailchimpWithRedirect extends React.Component {
  state = {};
  ...
  render() {
    ...
    const messages = {
      ...MailchimpWithRedirect.defaultProps.messages,
      ...this.props.messages
    }
...
MailchimpWithRedirect.defaultProps = {
  messages: {
    sending: "Sending...",
...
MailchimpWithRedirect.propTypes = {
...
export default MailchimpWithRedirect;