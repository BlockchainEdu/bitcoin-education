...
export default function PenicheHackerHouse() {
  return (
    <div className="overflow-hidden">
      <Header />
      <Head>
        <title>Peniche Hacker House | Build the Future</title>
      </Head>
      ...
      <section
        ...
        style={{
          backgroundImage: "url('/images/hackerhouses/peniche/main.png')",
      ...
      <section className="bg-white py-14 px-7">
        <div className="max-w-7xl m-auto text-center">
          <h2 className="text-4xl font-black text-benblack-500">Why Peniche?</h2>
        ...
        <div className="max-w-7xl m-auto flex flex-col lg:flex-row items-center lg:items-start">
          <div className="w-full lg:w-6/12 ml-10 mr-10">
            <h2 className="text-3xl font-black text-benblack-500 text-center lg:text-left">
              Your Stay at the Peniche Hacker House
            </h2>
