...
export default function ColivingApply() {
  ...
  // ── Input component ──
  function Field({ label, field, type = "text", required, placeholder, hint, rows }: { label: any; field: any; type?: string; required?: any; placeholder?: any; hint?: any; rows?: any }) {
  ...
  function SelectField({ label, field, options, required, hint }: { label: any; field: any; options: any[]; required?: any; hint?: any }) {
    return (
      <div className="mb-6">
        <label className="block font-inter font-semibold mb-2" style={{ fontSize: 14, color: "#1d1d1f" }}>
          {label}
