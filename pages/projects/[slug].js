  ...
  return (
    <>
      <div id="student-story">
        <Header />
        <div className="pt-40 py-24 max-w-7xl mx-auto flex flex-col lg:flex-row w-11/12">
          <div className="w-full lg:w-8/12">
            <div>
              <h1 className="bg-benorange-500 pl-6 font-mont text-white font-black text-2xl lg:text-3xl py-4">{project.place_name}</h1>
            </div>
