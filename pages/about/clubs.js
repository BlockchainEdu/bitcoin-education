...
export default function Partners() {
    ...
    return (
        <div id="partners-page">
            <HeaderWithLogoDark />
            <div className="pt-3 md:pt-40 pb-0 px-7">
                <div className="max-w-7xl m-auto flex flex-col lg:flex-row">
                    <div className="w-full ">
                        ...
                        <div className="m-auto flex content-center justify-center md:justify-start">
                            <button className="mb-20 md:mb-0 bg-benorange-500 hover:bg-bengrey-300 shadow-button transition duration-500 text-white font-bold text-xl px-16 rounded-full py-4 mt-10">
                                Sign Up 
                            </button>
                        </div>
                    </div>
            ...
            <section className="max-w-7xl m-auto pb-20 md:pb-24 pt-14">
                <div className="px-7">
                    <h2 className="text-black text-3xl md:text-4xl text-center md:text-left m-auto md:m-0 font-bold max-w-md pb-20">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-y-14 lg:gap-y-0 gap-x-14 font-mont">
                        {Benefits.map((Benefits) =>
                            <div>
                                <div className="text-xs uppercase pb-4 text-center md:text-left" style={{ color: "#acacac" }}>
                                    {Benefits.name}
                                </div>
                                <div style={{ maxWidth: "262px" }} className="text-center md:text-left m-auto md:m-0">
