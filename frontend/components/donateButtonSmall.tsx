            ...
            <div className="relative w-auto my-6 mx-auto max-w-3xl">
              ...
              <div className="border-0 donation-modal rounded-2xl shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                ...
                <div className="relative p-6 flex-auto">
                  ...
                  <a className="text-center" target="_blank" rel="noopener noreferrer" href={`https://www.paypal.com/donate/?hosted_button_id=${process.env.NEXT_PUBLIC_PAYPAL_BUTTON_ID || "JZT2VJ5WA6GJJ"}`}>
                    ...
                    <a className="text-center" target="_blank" rel="noopener noreferrer" href={`https://commerce.coinbase.com/checkout/${process.env.NEXT_PUBLIC_COINBASE_CHECKOUT_ID || "041362e5-b215-4484-82d9-fb27e513563a"}`}>
                    <button className="border font-bold text-xl px-8 rounded-full py-4 text-benblack-500 hover:bg-bengrey-300 transition duration-500 hover:border-bengrey-300">
                      Give with Crypto
                    </button>
                    </a>
