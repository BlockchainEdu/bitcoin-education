---
title: "See BEN at Mainnet 2021"
excerpt: "The Blockchain Education Network prides itself on making sure students have the opportunity to attend blockchain conferences and hackathons where they can learn, network and find job opportunities. We"
date: "2021-09-19"
author: "The BEN Team"
cover: "https://cdn-images-1.medium.com/max/1024/1*urY1dety_l1dtnwcRHBgMw.png"
featured: false
tags: ["ethereum","education","defi","blockchain"]
---

![](https://cdn-images-1.medium.com/max/1024/1*urY1dety_l1dtnwcRHBgMw.png)
...
To that end, thanks to student tickets provided by the Messari team, we put out an application to our network with the goals of bringing a diverse array of students from different universities to the conference. Additionally, we are providing a BEN Airbnb for students to stay at during the entirety of the conference. We had dozens of students apply, and while we could not accommodate everyone, we hope that we could bring more and more students to each subsequent conference. [Donate if you want to help support our mission](https://www.blockchainedu.org/)!
...
Additionally, during the conference, we will be conducting interviews between the students and speakers in the industry. The students have let us know what topics and projects they are interested in, and we are excited to help them meet potential future employers and make lifelong connections. The speakers are also excited to interview them, and the interviews will be [shared on our YouTube](https://www.youtube.com/c/BlockchainEdu) after the conference.
